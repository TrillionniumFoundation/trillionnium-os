...
Browse machine records under `machine/`; the directory name itself conveys no authority.
...
The baseline identities in `machine/current-baseline.v1.json` are a dated
