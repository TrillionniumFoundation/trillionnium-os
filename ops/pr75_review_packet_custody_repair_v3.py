...
wrapper = (
    ...
    "    \"\"\"Generate the checker with the descriptor-relative custody boundary.\"\"\"\n"
    ...
    f"    replacement = {CHECKER_ACQUISITION!r}\n"
...
method = r'''
    ...
    def test_review_packet_acquisition_is_nonblocking_and_descriptor_relative(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            fifo_digest = "0" * 64
            fifo_relative = f"docs/reviews/module-contracts/{fifo_digest}.json"
